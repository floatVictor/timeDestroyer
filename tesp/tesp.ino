...
const IPAddress destIp(192,168,1,14); // remote IP of the target device
...
// Button Input + LED Output                // D5 pin at NodeMCU (GPIO 14)
const int redPin = 16;                 // D6 pin at NodeMCU (GPIO 12)
const int greenPin = 5;                 // D7 pin at NodeMCU (GPIO 13)
const int bluePin = 4;                 // D8 pin at NodeMCU (GPIO 15)
